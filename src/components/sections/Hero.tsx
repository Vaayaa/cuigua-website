    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <p className="text-xl md:text-2xl text-[#8a8a9a] mb-2">
            {siteConfig.hero.subtitle}
          </p>
          <p className="text-lg text-[#8a8a9a]/60">
        ...
        >
          ...
          <p className="text-lg text-[#a855f7]">
        ...
        >
          <a
            href="#experience"
            className="px-8 py-4 bg-gradient-to-r from-[#ff6b35] to-[#a855f7] text-white font-semibold rounded-full hover:opacity-90 transition-opacity"
          >
            探索体验
          </a>
          <a
      ...
      >
        <svg viewBox="0 0 100 100" className="w-full h-full">
          ...
          {/* Face */}
          <motion.ellipse
            cx="40" cy="45" rx="5" ry="7"
            fill="#ff6b35"
            animate={{ scaleY: [1, 0.3, 1] }}
            transition={{ duration: 2, repeat: Infinity }}
          />
          <motion.ellipse
            cx="60" cy="45" rx="5" ry="7"
            fill="#ff6b35"
            animate={{ scaleY: [1, 0.3, 1] }}
          ...
          <motion.path
            ...
            strokeWidth="2"
            strokeLinecap="round"
            animate={{ d: ["M 35 60 Q 50 70 65 60", "M 35 60 Q 50 55 65 60", "M 35 60 Q 50 70 65 60"] }}
      ...
      >
        <motion.div
          ...
          className="text-[#8a8a9a] flex flex-col items-center gap-2"
        >
