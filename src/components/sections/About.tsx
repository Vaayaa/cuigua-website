  ...
  return (
    <section id="about" className="py-24 md:py-32 bg-[#0a0a0f]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <span className="text-sm text-[#ff6b35] font-mono tracking-widest mb-4 block">
            {siteConfig.about.titleEn}
          </span>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="glass rounded-2xl p-8">
              ...
              <p className="text-[#8a8a9a] leading-relaxed mb-4">
                {siteConfig.about.philosophy.text}
              </p>
              <p className="text-[#8a8a9a]/60 leading-relaxed text-sm">
                {siteConfig.about.philosophy.textEn}
              </p>
            </div>
            ...
            <div className="glass rounded-2xl p-8">
              ...
              <p className="text-[#8a8a9a] leading-relaxed mb-4">
                {siteConfig.about.concept.text}
              </p>
              <p className="text-[#8a8a9a]/60 leading-relaxed text-sm">
                {siteConfig.about.concept.textEn}
              </p>
            </div>
            ...
            <motion.blockquote
              ...
              className="border-l-4 border-[#ff6b35] pl-6 py-2"
            >
          ...
          >
            ...
            <svg className="absolute inset-0 w-full h-full" viewBox="0 0 400 400">
              <motion.path
                d="M 200 50 L 100 200 L 200 350 L 300 200 Z"
                fill="none"
                stroke="#ff6b35"
                strokeWidth="1"
                strokeDasharray="5 5"
            ...
            <motion.div
              ...
              className="absolute top-4 left-1/2 -translate-x-1/2 glass rounded-xl px-6 py-4"
            >
            ...
            <motion.div
              ...
              className="absolute top-1/2 left-4 -translate-y-1/2 glass rounded-xl px-6 py-4"
            >
            ...
            <motion.div
              ...
              className="absolute top-1/2 right-4 -translate-y-1/2 glass rounded-xl px-6 py-4"
            >
            ...
            <motion.div
              ...
              className="absolute bottom-4 left-1/2 -translate-x-1/2 glass rounded-xl px-6 py-4"
            >
